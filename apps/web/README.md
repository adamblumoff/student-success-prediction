...
- `/api/data/all` - Data export (query: `institutionId`, `includeStudents`, `includeInsights`, `includeInterventions`, includes `*Version` fields)
- `/api/insights/latest` - Latest GPT insights per student (includes `version`)
